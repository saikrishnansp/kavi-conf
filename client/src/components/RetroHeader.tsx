...
import { LogIn, LogOut, Menu, Shield, User, X, Zap } from "lucide-react";
...
export function RetroHeader({ userName }: RetroHeaderProps) {
  ...
  return (
    ...
    <>
      <header className='fixed top-0 left-0 right-0 z-50 border-b-4 border-primary bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/80'>
        <div className='container mx-auto px-4'>
          <div className='flex h-16 items-center justify-between'>
            {/* Logo */}
            <Link
              to={isAuthenticated ? "/agenda" : "/"}
